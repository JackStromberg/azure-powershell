...
```
Update-AzContainerRegistryTaskRun -Name <String> -RegistryName <String> -ResourceGroupName <String>
 -UpdateParameter <ITaskRunUpdateParameters> [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-AsJob]
 [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentity
```
Update-AzContainerRegistryTaskRun -InputObject <IContainerRegistryIdentity>
 -UpdateParameter <ITaskRunUpdateParameters> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api20190601Preview.ITaskRunUpdateParameters
