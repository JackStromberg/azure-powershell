...
online version: https://learn.microsoft.com/powershell/module/az.containerregistry/update-azcontainerregistryreplication
schema: 2.0.0
---
...
```
Update-AzContainerRegistryReplication -Name <String> -RegistryName <String> -ResourceGroupName <String>
 -ReplicationUpdateParameter <IReplicationUpdateParameters> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentity
```
Update-AzContainerRegistryReplication -InputObject <IContainerRegistryIdentity>
 -ReplicationUpdateParameter <IReplicationUpdateParameters> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api20220201Preview.IReplicationUpdateParameters
